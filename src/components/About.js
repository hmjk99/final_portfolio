    ...
    return(
        ...
        <section id="About">
            <div class="about-content" >
                <h3 data-aos="fade-left" data-aos-duration="1000" data-aos-easing="linear" class="section-subtitle">My Story</h3>
                <h1 data-aos="fade-left" data-aos-duration="1000" data-aos-easing="linear" class="section-title">About Me</h1>
                <div data-aos="fade-left" data-aos-duration="1000" data-aos-easing="linear" id="about-p">
                    <img src={img}/>
                ...
                <div data-aos="fade-left" data-aos-duration="1000" data-aos-easing="linear" id="fun-fact">
                    <h3>Fun Fact:</h3>
